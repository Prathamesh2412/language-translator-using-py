...
InputLanguageChoiceMenu = OptionMenu(Screen, InputLanguageChoice, *LanguageChoices, width=15, relief=GROOVE)
...
NewLanguageChoiceMenu = OptionMenu(Screen, TranslateLanguageChoice, *LanguageChoices, width=15, relief=GROOVE)
...
TextVar = StringVar()
TextBox = Entry(Screen, textvariable=TextVar, width=50).grid(row=4, column=1)

Label(Screen, text="Output Text").grid(row=4, column=2)
OutputVar = StringVar()
TextBox = Entry(Screen, textvariable=OutputVar, width=50).grid(row=4, column=3)
...
B = Button(Screen, text="Translate", command=Translate, relief=GROOVE, bg='#4CAF50', fg='white').grid(row=5, column=1, columnspan=3)
mainloop()